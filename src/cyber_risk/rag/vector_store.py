...
from cyber_risk.rag.embeddings import embed_texts
from cyber_risk.rag.nist_oscal import NistControlChunk
...
def upsert_pinecone(chunks: list[NistControlChunk], model_name: str, settings: Settings) -> None:
    ...
    from cyber_risk.rag.embeddings import get_embedding_model
